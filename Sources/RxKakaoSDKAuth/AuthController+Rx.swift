...
//extension AuthController {
    ...
    /// :nodoc:
    @available(iOSApplicationExeption, unavailable)
    public func authorizeWithTalk(channelPublicIds: [String]? = nil,
        ...
        return Observable<String>.create { observer in
            ...
            let parameters = AUTH_CONTROLLER.makeParametersForTalk(channelPublicIds: channelPublicIds, serviceTerms: serviceTerms)
