...
let package = Package(
    ...
    dependencies: [
      .package(name: "RxAlamofire", url: "https://github.com/RxSwiftCommunity/RxAlamofire", .upToNextMajor(from: "5.2.0")),
      .package(name: "RxSwift", url: "https://github.com/ReactiveX/RxSwift", .upToNextMajor(from: "5.1.0")),
