...
let package = Package(
  ...
  dependencies: [
    .package(name: "RxAlamofire", url: "https://github.com/RxSwiftCommunity/RxAlamofire", "5.1.0"..<"7.0.0"),
    .package(name: "RxSwift", url: "https://github.com/ReactiveX/RxSwift", "5.1.0"..<"7.0.0"),
